...
/*   Updated: 2022/05/06 17:32:31 by echerell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "\033[32mInitializing constructor called\033[37m\n";
}
...
void	ClapTrap::attack(const std::string &target)
{
	...
	{
		std::cout << "ClapTrap " << this->_m_name << " attacks " << target
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << "ClapTrap " << this->_m_name
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	if (this->_m_enrgPt)
	{
		this->_m_hitPt += amount;
		this->_m_enrgPt--;
		std::cout << "ClapTrap " << this->_m_name << " repaired itself for "
